...
# -*- coding: utf-8 -*-
"""
Created on Thu Feb  9 11:51:01 2017
...
def oddTuples(aTup):
    ...
    for i in range(len(aTup)):
        if i % 2 == 0:
            oTup = oTup + aTup[i:i+1] #also okay for (aTup[i],),should make sure returing a tuple
    return oTup
    
#examples given by course
def oddTuples1(aTup):
    '''
    aTup: a tuple
